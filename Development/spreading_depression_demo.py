# -*- coding: utf-8 -*-
"""
Created on Wed Aug  2 12:26:19 2023
...
h.nrn_load_dll("C:/Users\Floarea/Desktop/model/rxd_ecs")
...
# set the save directory and if buffering or inhomogeneous tissue characteristics are used.
class MyObject:
    def __init__(self, **kwargs): 
        for key, value in kwargs.items():
            setattr(self, key, value)

args = MyObject(dir=".", edema="0", buffer="0", tstop=100) #30000 in the paper
...
if args.buffer:
    # Additional species are used for a phenomenological model of astrocytic buffering 
    kb = 0.0008
    kth = 15.0
